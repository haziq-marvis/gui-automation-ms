...
import win32process
import win32gui
from PIL import Image  # Import from Pillow for image processing
import pyautogui  # For capturing screenshots and cursor position
import io  # For handling in-memory byte streams
import base64  # For encoding images in base64 format
from .core_imaging import focus_window, capture_screenshot, encode_image  # Custom imports
